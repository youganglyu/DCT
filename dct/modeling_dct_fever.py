...
from dct.wrapper_dct_fever import TransformerModelWrapper
...
def train_dct(train_data: List[InputExample],
    ...
    if do_train:
        if not os.path.exists(output_dir):
            ...
            train_single_model(train_data, eval_data,eval_data2, dev_data, output_dir, wrapper, train_config, eval_config)
    if do_eval:
        wrapper = init_model(model_config)
        wrapper.only_eval(eval_data, eval_data2, dev_data, eval_config, train_config.n_gpu)

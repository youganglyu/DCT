...
bias_data_index=np.load('hard_index.npy')
for ttt in range(1,6):
    ...
    np.save('mnli01_tbert_emb_hard_epoch'+epoch, embs01)
    np.save('mnli02_tbert_emb_hard_epoch'+epoch, embs02)
    np.save('mnli12_tbert_emb_hard_epoch'+epoch, embs12)

    np.save('mnli01_tbert_all_hard', dic_01_all)
    np.save('mnli02_tbert_all_hard', dic_02_all)
    np.save('mnli12_tbert_all_hard', dic_12_all)

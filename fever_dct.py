...
from data_utils.task_processors import PROCESSORS, load_examples, TRAIN_SET, DEV_SET, HARD_SET, HARD_SET2, METRICS, DEFAULT_METRICS
from dct.utils import eq_div

from dct.config import TrainConfig, EvalConfig, WrapperConfig
from dct.modeling_dct_fever import train_dct
import time
import log
...
def main():
    ...
    eval_data2 = load_examples(
        args.task_name, args.data_dir, HARD_SET2, num_examples=-1, num_examples_per_label=eval_ex_per_label)
